      ...
      <div className="ml-auto flex items-center gap-1">
        ...
        {user.role === 'buyer' && (
          ...
          >
            ...
            {cartCount > 0 && (
              <span className="absolute top-1 right-1 min-w-4 h-4 bg-rose-500 text-white text-xs rounded-full flex items-center justify-center px-1 font-heading leading-none">
